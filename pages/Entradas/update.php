...
<body>
  ...
  if (isset($_GET['id'])) {
    $sql = "SELECT * FROM entradas WHERE id = " . $_REQUEST['id'];
      ...
      <form action="./controller.php?id='<?php echo $_GET['id'] ?>'" method="post" id="form">
        ...
        <div class="row mt-2">
          <div class="col">
            ...
            <input type="text" name="nota" id="nota" value="<?php echo $row->nota?>" class="form-control" placeholder="NF 16341">
          </div>
        ...
        <div class="row mt-4">
          <div class="col w-50">
            <a href="./controller.php?id=<?php echo $_REQUEST['id'] ?>&acao=deletar" class="btn btn-danger w-100 fs-5 fw-semibold" onclick="return confirm('Tem certeza que deseja excluir essa entrada?')">
              Deletar
            </a>
          </div>
